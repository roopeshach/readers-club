...
<div class="bg-gray-800 p-6 rounded-lg shadow-lg">
    <h2 class="text-3xl font-semibold text-purple-400 mb-6">Edit Book</h2>
    ...
    <form action="{{ route('books.update', $book) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="book_title" id="book_title" class="w-full p-2 rounded bg-gray-900 text-gray-100" value="{{ $book->book_title }}" required>
        </div>

        <div class="mb-4">
            <label for="book_code" class="block text-gray-300">Book Code</label>
            <input type="text" name="book_code" id="book_code" class="w-full p-2 rounded bg-gray-900 text-gray-100" value="{{ $book->book_code }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="cover_image_path" id="cover_image_path" class="w-full p-2 rounded bg-gray-900 text-gray-100" value="{{ $book->cover_image_path }}">
        </div>

        <div class="mt-6">
            <button type="submit" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">Update Book</button>
        </div>
    </form>
</div>
@endsection
